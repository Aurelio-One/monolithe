...
const ReStyling = ({data}) => {
    ...
    return (
        <React.Fragment>
            ...
            <ParallaxImage className="section-margin" src="/assets/img/project/project3/.jpg" caption="Neorama"/>
            {/*End Parallax Image*/}
            ...
            {/*Start Parallax Image*/}
            <ParallaxImage className="section-margin" src="/assets/img/project/project3/5.jpg" caption="Neorama"
